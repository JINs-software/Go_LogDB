...
type ProduceRequest struct {
	...
	Record *Record `protobuf:"bytes,1,opt,name=record,proto3" json:"record,omitempty"` // 로그에 생성할 레코드를 가짐
}
...
type ProduceResponse struct {
	...
	Offset uint64 `protobuf:"varint,1,opt,name=offset,proto3" json:"offset,omitempty"` // 레코드의 오프셋을 회신 (오프셋은 사실상 레코드 ID)
}
...
type ConsumeRequest struct {
	...
	Offset uint64 `protobuf:"varint,1,opt,name=offset,proto3" json:"offset,omitempty"` // 로그에서 소비할 레코드의 오프셋을 가짐
}
...
type ConsumeResponse struct {
	...
	Record *Record `protobuf:"bytes,1,opt,name=record,proto3" json:"record,omitempty"` // 오프셋에 저장된 레코드를 회신
}
...
var file_log_proto_rawDesc = []byte{
	...
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4a, 0x49, 0x4e, 0x73, 0x2d, 0x73, 0x6f, 0x66, 0x74, 0x77,
	0x61, 0x72, 0x65, 0x2f, 0x47, 0x6f, 0x4c, 0x6f, 0x67, 0x44, 0x42, 0x2f, 0x61, 0x70, 0x69, 0x2f,
